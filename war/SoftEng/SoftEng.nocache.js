...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "SoftEng" because\n';
  ...
  $wnd.__gwt_activeModules['SoftEng'] = {
    'moduleName' : 'SoftEng',
    'bindings' : function() {
      return {};
    }
 ...
 * "/SoftEng.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['SoftEng'].superdevmode = true;

  var expectedSuffix = '/SoftEng.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + SoftEng + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:SoftEng';
  var devModeSessionKey = '__gwtDevModeSession:SoftEng';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/SoftEng/SoftEng.nocache.js';
  ...
  $wnd.__gwt_activeModules['SoftEng'].canRedirect = true;
  $wnd.__gwt_activeModules['SoftEng'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/SoftEng?user.agent=' + ua + '&_callback=' + callback;
